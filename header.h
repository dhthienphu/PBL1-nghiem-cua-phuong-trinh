...
void sumAndmulti(float matrixA[1000][1000], float matrixB[1000][1000], int n, float matrixAns_sum[1000][1000], float matrixAns_multi[1000][1000])
{
    for (int i = 0; i < n; i++)
    {
        for (int j = 0; j < n; j++)
...
void printResultToFile(FILE *file, char *fileName, int n, float matrixA[1000][1000], float matrixB[1000][1000], float matrixAns_sum[1000][1000], float matrixAns_multi[1000][1000])
{
